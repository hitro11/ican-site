...
<div class="center">
  ...
  <div class="form-inline flex-between">
    ...
    <input type="number" class="form-control" id="num-child-under22" name="num-child-under22" aria-describedby="num-child-under22-help" placeholder="Street">
  </div>
  <div class="form-inline flex-between">
    <label for="street">Total number of children over 22 years old</label>
    <input type="number" class="form-control" id="num-child-over22" name="num-child-over22" aria-describedby="num-child-over22-help" placeholder="Street">
  </div>
